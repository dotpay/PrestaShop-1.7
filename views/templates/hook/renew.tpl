...
<div class="box" style="overflow: auto;">
    <h2 class="page-subheading"><a href="http://www.dotpay.pl" target="_blank" title="www.dotpay.pl"><img id="dotpay-logo" src="{$moduleDir2}views/img/p24_logo.png" alt="Dotpay - {l s='Fast and secure Internet payments' mod='dotpay'}"/></a>&nbsp;{l s='Pay easy with Dotpay' mod='dotpay'}</h2>
    {if $isRenew}
