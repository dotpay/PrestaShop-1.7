...
class Mp extends Channel
{
    ...
    {
        parent::__construct(Configuration::MP_CHANNEL, self::CODE, $config, $transaction, $paymentResource, $sellerResource);
    }
    ...
    {
        return parent::isVisible() && $this->config->getMpVisible();
    }
}
